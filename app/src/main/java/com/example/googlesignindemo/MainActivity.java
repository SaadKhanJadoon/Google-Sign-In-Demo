...
public class MainActivity extends AppCompatActivity {
    ...
    private void findViews() {
        defaultSignInButton = findViewById(R.id.googleSignIn);
        customSignInButton = findViewById(R.id.customSignIn);
        userDetailLabel = findViewById(R.id.userDetailLabel);
        userProfileImageView = findViewById(R.id.userProfileImage);

        defaultSignInButton.setOnClickListener(view -> doSignInSignOut());
    }
     ...
     */
    private void getProfileInformation(GoogleSignInAccount signInAccount) {
        ...
        if (signInAccount != null) {
            ...
            //user last name
            String personFamilyName = signInAccount.getFamilyName();
            //user email id
            ...
            userDetailLabel.setText("User ID : " + personId +
